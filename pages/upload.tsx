        ...
        <div className="flex flex-col gap-3 pb-10">
          ...
          >
            {topics.map((topic) => (
              <option
                key={topic.name}
                value={topic.name}
                className="bg-white text-gray-700 text-md p-2 hover:bg-slate-300"
              >
                {topic.name}
              </option>
            ))}
          ...
          <div className="flex gap-6 mt-10">
            ...
            <button
              onClick={handlePost}
              type="button"
              className="bg-[#F51997] border-2 text-white font-medium p-2 rounded w-28 lg:w-44 outline-none"
            >
              Post
            </button>
          </div>
